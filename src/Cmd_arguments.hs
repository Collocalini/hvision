...
argument_type_22052017_classifier_test,
...
default_type_22052017_classifier_test,
...
data InputArguments = InputArguments {
     ...
     ,type_22052017_classifier_test :: Maybe Bool
...
inputArgs tm = InputArguments {
  ...
  ,type_22052017_classifier_test = type_22052017_classifier_test'
  ...
  type_22052017_classifier_test'
    |s == "True" = Just True
    |s == "False" = Just False
    |otherwise = Nothing
    where
    s = (DMap.findWithDefault default_type_22052017_classifier_test
                              argument_type_22052017_classifier_test tm)
...
argument_type_22052017_classifier_test = "type-22052017-classifier-test"
...
default_type_22052017_classifier_test = "false"
...
tag_DMap [] = DMap.fromList [
        ...
        (argument_type_22052017_classifier_test, default_type_22052017_classifier_test),
